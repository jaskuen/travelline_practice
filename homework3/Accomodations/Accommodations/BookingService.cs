...
public class BookingService : IBookingService
{
    ...
    public decimal CalculateCancellationPenaltyAmount(Booking booking)
    {
        ...
        {
            return 10000.0m; // отмена в день брони, значит штраф на максимальную сумму - 10000 у.е.
        }
    ...
    private static decimal GetCurrencyRate(Currency currency)
    {
        ...
        {
            Currency.Usd => CurrencyValues.Usd, // теперь случайные значения валют генерируются один раз 
